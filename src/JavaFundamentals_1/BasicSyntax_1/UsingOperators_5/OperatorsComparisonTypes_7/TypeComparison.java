package JavaFundamentals_1.BasicSyntax_1.UsingOperators_5.OperatorsComparisonTypes_7;
/*El instanceof el operador compara un objecto con un tipo especificado. Puede usarlo para
probar si un objecto es una instancia de una clase, una instancia de una subclase o una
instancia de una clase que implementa una interfaz particular*/
